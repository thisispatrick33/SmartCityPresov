        ...
        if(data===null){
            ...
            return (
                <div className={"row"}>
                    ...
                    {data.filter(item => item.done === 0).map(({id, title, author, description})=>{
                        return(
                                    ...
                                    <div className={'project-content | row col-12 | m-0 p-0 | justify-content-center'}>
                                        <div className={'col-10 | p-0 mx-0 mt-3 mb-2'}>
                                            ...
                                            <p className={'description'}>
                                                ...
                                                <span className={'show-more'} onClick={() => hide(id)}>Delete</span>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div className={"col-12"} onClick={() => navigate('/create')}>Create</div>
                </div>
            );
        }
    }
